...
const features = [
  {
    number: "01",
    title: "Hyper-Personalized AI Chat",
    description: "Explain complex topics in Hinglish step-by-step.",
    visual: "ai",
  },
  {
    number: "02",
    title: "Adaptive Daily Study Plan",
    description: "Tells you what to study based on your available time.",
    visual: "deploy",
  },
  {
    number: "03",
    title: "Smart Quiz Generator",
    description: "Instant quizzes to highlight your weak areas.",
    visual: "security",
  },
  {
    number: "04",
    title: "Voice-First Learning",
    description: "Speak your doubts directly to Mitra.",
    visual: "collab",
  },
];
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 py-12 lg:py-20 border-b border-foreground/10">
        ...
        <div className="flex-1 grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-48 h-40 text-foreground" suppressHydrationWarning>
              {isMounted && <AnimatedVisual type={feature.visual} />}
            </div>
          </div>
        </div>
      </div>
