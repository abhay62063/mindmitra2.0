...
const steps = [
  {
    ...
    description: "Tell us what you're studying and set your target.",
    code: `mitra.setGoal({
  ...
  },
  {
    ...
    description: "Ask doubts in your language.",
    code: `mitra.ask("Bhaiya, binary tree traversal bata do")

// Mitra: Binary tree traversal ke 3 types hain:
...
// 3. Postorder (Left, Right, Root)`,
  },
  {
    number: "III",
    title: "Track Growth",
    description: "See your progress on the dashboard.",
    code: `mitra.getProgress()

// Response:
// 📈 Data Structures: 85% completed
// 🎯 Weak areas: Dynamic Programming
// ⚡ Next suggested topic: Graphs`,
  },
];
